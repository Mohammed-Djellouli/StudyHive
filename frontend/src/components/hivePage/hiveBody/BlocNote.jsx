...
const TiptapBlocNote = ({ isChatVisible }) => {
    ...
    return (
        <div className="bg-[#1e1f21] text-white p-4 rounded-lg relative shadow-md h-full w-full transition-all duration-500">
        ...
        {/* Barre outils */}
            ...
            <div className="bg-transparent text-white h-full overflow-y-auto pr-1 bloc-Note ">
